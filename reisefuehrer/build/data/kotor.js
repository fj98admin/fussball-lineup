...
module.exports = {
  ...
  map: {
    ...
    points: [
      ...
      { n: 5, x: 40, y: 18, cat: 'activity', label: 'Festung San Giovanni' },
      { n: 6, x: 64, y: 46, cat: 'food', label: 'Konoba Scala Santa', minor: true },
      { n: 7, x: 20, y: 40, cat: 'practical', label: 'ATM/Apotheke', minor: true },
      { n: 8, x: 85, y: 82, cat: 'sight', label: 'Perast & Our Lady of the Rocks', anchor: 'end' },
      { n: 9, x: 58, y: 14, cat: 'sight', label: 'Leiter von Kotor (Ladder)' },
      { n: 10, x: 16, y: 16, cat: 'sight', label: 'Kotor–Lovćen Seilbahn', anchor: 'start' },
      { n: 11, x: 70, y: 50, cat: 'food', label: 'Forza Mare', minor: true },
      { n: 12, x: 96, y: 62, cat: 'food', label: 'Boka Seafood / Luka\'s Oyster Farm → Risan', minor: true },
      { n: 13, x: 56, y: 42, cat: 'food', label: 'Pescaria Dekaderon', minor: true },
      { n: 14, x: 30, y: 47, cat: 'cafe', label: 'Mon Bistro / Dojmi', minor: true },
    ],
  },
  qr: {
