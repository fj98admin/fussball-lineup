...
module.exports = {
  ...
  map: {
    ...
    points: [
      ...
      { n: 4, x: 47, y: 30, cat: 'sight', label: 'San Giusto' },
      { n: 5, x: 36, y: 53, cat: 'sight', label: 'Canal Grande' },
      { n: 6, x: 46, y: 42, cat: 'food', label: 'Buffet da Pepi' },
      { n: 7, x: 20, y: 59, cat: 'cafe', label: 'Caffè Tommaseo' },
      { n: 8, x: 34, y: 68, cat: 'practical', label: 'Despar/ATM' },
    ],
  },
  qr: {
