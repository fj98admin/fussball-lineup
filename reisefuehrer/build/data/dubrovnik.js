...
module.exports = {
  ...
  map: {
    ...
    points: [
      ...
      { n: 3, x: 66, y: 74, cat: 'sight', label: 'Stadtmauer' },
      { n: 4, x: 75, y: 78, cat: 'sight', label: 'Stradun' },
      { n: 5, x: 86, y: 82, cat: 'photo', label: 'Buža Bar' },
      { n: 6, x: 62, y: 62, cat: 'sight', label: 'Fort Lovrijenac' },
      { n: 7, x: 78, y: 66, cat: 'food', label: 'Konoba Dubrava' },
      { n: 8, x: 50, y: 82, cat: 'practical', label: 'Apotheke/ATM' },
    ],
  },
  qr: {
