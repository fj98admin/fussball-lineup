...
module.exports = {
  ...
  map: {
    ...
    mesh: autoGridMesh([[{ x: 6, y: 16 }, { x: 96, y: 16 }, { x: 96, y: 72 }, { x: 6, y: 72 }]], { step: 6, angle: 6 }),
    points: [
      ...
      { n: 6, x: 10, y: 34, cat: 'photo', label: 'Marjan-Hügel (Vidilica & Telegrin)', anchor: 'start' },
      { n: 7, x: 94, y: 72, cat: 'sight', label: 'Bačvice Beach' },
      { n: 8, x: 26, y: 58, cat: 'practical', label: 'Apotheke/ATM', minor: true },
      { n: 9, x: 62, y: 66, cat: 'sight', label: 'Palast-Substruktionen' },
      { n: 10, x: 72, y: 82, cat: 'photo', label: 'Riva-Promenade', minor: true },
      { n: 11, x: 42, y: 64, cat: 'food', label: 'Konoba Stare Grede / Tri Volta', minor: true },
      { n: 12, x: 48, y: 56, cat: 'food', label: 'Storija / Restaurant Dvor', minor: true },
      { n: 13, x: 20, y: 68, cat: 'food', label: 'Konoba Fetivi (Veli Varoš)', minor: true },
      { n: 14, x: 60, y: 60, cat: 'cafe', label: 'KaKantun Coffee & Gin', minor: true },
      { n: 15, x: 96, y: 78, cat: 'food', label: 'Tropic Club', minor: true },
    ],
  },
  qr: {
